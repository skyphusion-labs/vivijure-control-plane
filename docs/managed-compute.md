...
**SUPERSEDED product shape (2026-08):** hosted tenants do not BYOK. They ride the
shared pool. A consumer reaches RunPod through this product or not at all. The
`byok` column below is historical. The meter + prepaid-credits design still
applies to the shared pool.

Status: DESIGN for full managed prepaid product; ledger + ManualRail + holds are SHIPPED but creditsApplyToTenant stays false (surface dark), ruled by Conrad 2026-07-25 (vivijure-cf#224 comments). The architecture below is
